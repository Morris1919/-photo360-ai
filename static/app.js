...
$$(".format").forEach(b=>b.onclick=()=>{
  $$(".format").forEach(x=>x.classList.remove("active"));b.classList.add("active");state.format=b.dataset.format;
  el.grid.style.opacity=state.format==="mp3"?".42":"1";el.grid.style.pointerEvents=state.format==="mp3"?"none":"auto";
});
